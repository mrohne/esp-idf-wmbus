...
const uint8_t sModeRfConfig[] = {
    ...
    TI_CCxxx0_FREQ1,     0x65,   //Frequency control word, middle byte.
    TI_CCxxx0_FREQ0,     0x6A,   //Frequency control word, low byte.
    TI_CCxxx0_MDMCFG4,   0x6A,   //Modem configuration.
    TI_CCxxx0_MDMCFG3,   0x4A,   //Modem configuration.
    ...
    TI_CCxxx0_DEVIATN,   0x47,   //Modem deviation setting (when FSK modulation is enabled).
    ...
    TI_CCxxx0_BSCFG,     0x6D,   //Bit synchronization Configuration.
    TI_CCxxx0_AGCCTRL2,  0x04,   //AGC control.
...
const uint8_t sModePaTable[] = {0xC2};
const uint8_t sModePaTableLen = 1;
